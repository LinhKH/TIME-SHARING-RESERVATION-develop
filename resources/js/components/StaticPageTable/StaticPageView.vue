<template>
    <div>
        <ul
            ...
            <li class="sidebar__item" :class="[currentStep == sidebar.id ? 'active' : '']"
                v-for="(sidebar, index) in sideBarSteps" :key="index">
                <div :class="[currentStep == sidebar.id ? classActive : '']"
                    class="block py-2.5 px-4 cursor-pointer bg-white" :href="`${sidebar.url}`">
            ...
            <modal v-if="isShowModal" @closeModal="handleModalDelete">
                ...
                <template v-slot:foot>
                    <div class="flex justify-end gap-4 p-6 space-x-2 rounded-b break-all">
                        <button @click="handleModalDelete"
                ...
                <div class="flex">
                    ...
                    <div class="w-full mb-[5px]">
                        <Field id="key" name="key"
                            class="w-[50%] border border-gray-300 outline-none px-[12px] py-3 rounded" type="text"
                            v-model="newDetail.key" disabled />
                        <div>
                ...
                <div class="flex">
                    ...
                    <div class="w-full h-full flex mb-[5px]">
                        ...
                        <Field id="title" name="title"
                            class="w-[100%] border border-gray-300 outline-none px-[12px] py-3 rounded" type="text"
