<template>
    <div class="flex flex-wrap mx-auto">
        <div class="cursor-pointer p-2 min-w-[75px] border-b border-solid border-[#ddd] hover:bg-[#eee] transition-all duration-200"
            :class="item.isActive && 'border-b-2 border-[red]'" v-for="(item, index) in listMenuEdit" :key="index"
