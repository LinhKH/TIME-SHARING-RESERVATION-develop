                        ...
                        <div>
                            <div class="mb-[8px]">
                                ...
                                <div class="flex w-full mt-[5px]">
                                    ...
                                    <div class="flex-1">
                                        <DatePicker placeholder="09:30" v-model="formDate.substitute_first_choice_time"
                                            startingView="time" inputFormat="HH:mm" minimumView="time"
                                            class="w-full flex-1 border border-slate-300 focus:outline-none rounded block px-[12px] py-[6px] border border-[#ccc] h-[34px]" />
                                    </div>
                                </div>
                            </div>
                            <div class="mb-[8px]">
                                ...
                                <div class="flex w-full mt-[5px]">
                                    ...
                                    <div class="flex-1">
                                        <DatePicker placeholder="09:30" v-model="formDate.substitute_second_choice_time"
                                            startingView="time" inputFormat="HH:mm" minimumView="time"
                                            class="w-full flex-1 border border-slate-300 focus:outline-none rounded block px-[12px] py-[6px] border border-[#ccc] h-[34px]" />
                                    </div>
                                </div>
                            ...
                            <div class="mb-[8px]">
                                ...
                                <div class="flex w-full mt-[5px]">
                                    ...
                                    <div class="flex-1">
                                        <DatePicker placeholder="09:30" v-model="formDate.substitute_third_choice_time"
                                            startingView="time" inputFormat="HH:mm" minimumView="time"
                                            class="w-full flex-1 border border-slate-300 focus:outline-none rounded block px-[12px] py-[6px] border border-[#ccc] h-[34px]" />
                                    </div>
                                </div>
