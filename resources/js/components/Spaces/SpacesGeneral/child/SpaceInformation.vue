    ...
    <LayoutForm :title="$t('spaces_general_page.space_info')" icon="fa fa-home">
            ...
            <div class="flex">
                <div class="form-card-group">
                    <div class="w-80 rounded border border-solid border-[#ddd] flex">
                        ...
                        <FormKit type="number" name="general_space_information_minimum_capacity"
                            input-class="focus:shadow-lg focus:shadow-cyan-500/50 focus:border-cyan-500/50 px-2 outline-none  h-9 w-full"
                            outer-class="flex-1" validation="required|number" min="1" :validation-messages="{
                ...
                <div class="form-card-group">
                    <div class="w-80 rounded border border-solid border-[#ddd] flex ml-5">
                        ...
                        <FormKit type="number" min="1" name="general_space_information_maximum_capacity"
                            input-class="focus:shadow-lg focus:shadow-cyan-500/50 focus:border-cyan-500/50 px-2 outline-none  h-9 w-full"
                            outer-class="flex-1" validation="required|number" :validation-messages="{
                                required: $t('validation.required'),
                                number: $t('validation.number'),
                            }" message-class="text-[red] mt-2" />
        ...
        <div class="flex mt-2 items-center">
            ...
            <div class="flex-1">
                <div class="w-[660px] border border-solid border-[#ddd] rounded flex">
                    ...
                    <FormKit type="textarea" name="general_space_information_spaciousness_description_ja"
                        :placeholder="$t('spaces_general_page.placeholder_6')" outer-class="w-full"
        ...
        <div class="flex mt-2 items-center">
            ...
            <div class="flex-1">
                <div class="w-[800px] border border-solid border-[#ddd] rounded flex">
                    ...
                    <FormKit type="textarea" name="general_space_information_plan_ja"
                        :placeholder="$t('spaces_general_page.placeholder_7')" outer-class="w-full"
        ...
        <div class="flex mt-2 items-center">
            ...
            <div class="flex-1 border border-solid border-[#ddd] rounded">
                <FormKit type="textarea" name="general_space_information_movie" outer-class="w-full" class="pt-[6px]"
        ...
        <div class="flex mt-2 items-center">
            ...
            <div class="flex-1">
                <div class="w-full border border-solid border-[#ddd] rounded flex">
                    ...
                    <FormKit type="textarea" name="general_space_information_terms_of_service"
                        :placeholder="$t('spaces_general_page.placeholder_8')" outer-class="w-full"
        ...
        <div class="mt-2">
            <div v-for="(item, index) in amountCancellation" :key="index" class="mb-2 flex items-center">
                ...
                <div class="flex-1 flex items-center">
                    <div class="flex h-9">
                        ...
                        <div
                            class="w-11 h-full border border-solid border-[#ddd] rounded flex items-center justify-center">
                            日</div>
                    </div>
                    <span class="inline-block mx-3"> ~ </span>
                    <div class="flex h-9">
                        <select v-model="item.endDay"
                            class="w-[150px] h-full px-2 bg-white border border-solid border-[#ddd] rounded outline-none focus:shadow-lg focus:shadow-cyan-500/50 focus:border-cyan-500/50">
                            <option :value="option.value" v-for="option in OPTIONS_DATE" :key="option.value">
                                {{ option.label }}
                            </option>
                    ...
                    <div class="flex ml-3 items-center">
                        <div class="border mr-1 border-solid border-[#ddd] rounded w-20">
                            <input v-model="item.percentage" required max="100" type="number"
                    ...
                    <div class="group ml-10 border-solid border border-[#d43f3a] rounded flex items-center justify-center h-9 w-9 hover:bg-[#d43f3a]"
            ...
            <button class="bg-[#ffbd00] px-2 py-1 rounded hover:translate-y-[2px] transition-all"
        ...
        <div class="flex mt-2 items-center">
            ...
            <div class="flex-1">
                <div class="w-full border border-solid border-[#ddd] rounded flex">
                    ...
                    <FormKit type="textarea" name="general_space_information_cancellation_policy"
                        :placeholder="$t('spaces_general_page.placeholder_9')" outer-class="w-full"
