    ...
    <div>
        ...
        <div class="flex justify-center">
            <div class="w-full pt-[20px] px-[5%] md:w-[38%]">
                ...
                <div class="mt-[70px]">
                    <h3 class="text-[18px] text-[#000000] mb-[20px] leading-[24px]">{{ $t(`form_auth.create_with_email`)
                        }}</h3>
                    <form @submit="submitForm">
                        ...
                        <div class="flex align-center pt-[10px]">
                            ...
                            <span class="text-[#626262]"><router-link to="/" class="text-[#1890ff]">{{
                                    $t(`form_auth.agreement`) }}</router-link>{{ $t(`form_auth.when`) }}
                                <router-link to="/" class="text-[#1890ff]">{{ $t(`form_auth.personal_information`)
                                    }}</router-link>
