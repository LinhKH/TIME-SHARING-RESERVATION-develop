<template>
    <div class="p-3">
                ...
                <tr v-for="(item, index) in listSpaces" :key="index" class="odd:bg-white even:bg-[#f9f9f9]">
                    ...
                    <td class="">
                        <div class="flex justify-center">
                            <div class="text-[10px] w-[90%] rounded text-center py-1 bg-white border border-solid"
                                :class="item.status === STATUS_SPACE.PENDING || item.status === STATUS_SPACE.ARCHIVED
                                        ? 'text-[red] border-[red]'
                    ...
                    <td class="">
                        <div class="flex justify-center cursor-pointer">
                            <div class="bg-white px-3 py-1 rounded border cursor-pointer"
                                @click="() => goToEditSpace(item)">
        ...
        <Pagination v-if="pagination" :pageCurrent="pagination.current_page" :totalPage="pagination.total"
            :isShowPrev="pagination.current_page != 1" :isShowNext="pagination.current_page != pagination.total"
