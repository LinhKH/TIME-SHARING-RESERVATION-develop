...
final class RentalSpacePostEquipmentInformationApplicationService
{
    /**
     ...
     *
     * @param RentalSpacePostEquipmentInformationCommand $command
     * @return RentalSpacePostEquipmentInformationResult
     * @throws TransactionException
     * @throws \App\Bundle\Common\Domain\Model\InvalidArgumentException
     */
    public function handle(RentalSpacePostEquipmentInformationCommand $command): RentalSpacePostEquipmentInformationResult
    {
        ...
        DB::beginTransaction();
        try {
            $rentalSpaceResponse = $this->rentalSpaceEquipmentInformationRepository->createRentalSpaceEquipmentInformation($rentalSpace);
            DB::commit();
        } catch (Exception $e) {
            DB::rollBack();
            Log::error($e);
        ...
        return new RentalSpacePostEquipmentInformationResult(
            $id->getValue(),
            $draftStep->getValue()
        );
    }
