...
final class SystemConfigPutCommand
{
     ...
     * @param bool $requestNotification requestNotification
     * @param bool $receiveNewsletter receiveNewsletter
     * @param array $authorityType authorityType
     * @param bool $invoiceCharge invoiceCharge
     */
