...
class UserManagePutRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            'password.min' => ':attributeは:8文字以上で入力して下さい。',
